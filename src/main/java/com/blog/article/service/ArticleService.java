...
public class ArticleService {
    ...
    public List<Article> newArticle() {
        return dao.newArticle();
    }

    public List<Article> mostView() {
        return dao.mostView();
    }

    public List<Article> mostComment() {
        return dao.mostComment();
    }

    public List<Article> list(int p) {
        return dao.list(p);
    }
    ...
    public boolean updateViewCount(int p, int count) {
        return dao.updateViewCount(p, count);
    }

    public boolean updateViewCount(int p) {
        return dao.updateViewCount(p, 20);
    }
}
